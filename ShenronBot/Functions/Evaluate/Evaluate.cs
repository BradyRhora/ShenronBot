namespace ShenronBot
{
    ...
    public static class EvalService
    {
        ...
        public static IEnumerable<string> Imports => ShenronBot.Globals.EvalImports;

        #endregion Private Fields + Properties   

        #region Public Methods

        public static async Task<string> EvaluateAsync(ICommandContext IContext, string script)
        {
            var Context = IContext as CommandContext;
